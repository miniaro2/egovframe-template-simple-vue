    ...
    <div class="c_wrap">
      ...
      <div class="location">
        <ul>
          ...
          <li><router-link :to="URL.ABOUT">사이트 소개</router-link></li>
          <li>소개</li>
        </ul>
      </div>
      <!--// Location -->
      ...
      <div class="layout">
        ...
        <div class="contents SITE_INTRO" id="contents">
          <!-- 본문 -->

          <h1 class="tit_3">사이트 소개</h1>

          <p class="txt_1">표준프레임워크 경량환경의 개요와 연혁, 조직소개,<br />
            표준프레임워크센터의 약도 등의 정보를 제공하고 있습니다.</p>

          <h2 class="tit_4">전자정부표준프레임워크 소개</h2>

          <h3 class="tit_5">개요</h3>
          ...
          <div class="ds_1">
            ...
            <h4 class="t_1">전자정부 서비스 품질향상 및 정보화투자 효율성 향상</h4>
            ...
            <p class="t_2">전자정부표준프레임워크<br />활용</p>

            <div class="bot">
              <h4 class="t_3">전자정부표준프레임워크 구축 및 적용 요구</h4>
              <ul>
              ...
              <p class="t_4">전자정부표준프레임워크는 응용SW의 구성기반이 되며 응용SW실행 시 필요한 기본 기능을 제공하는 환경으로
            ...
            <h3 class="tit_5">배경</h3>
            <p class="msg_1">현재 전자정부는 유사한 기능을 가지는 다양한 종류 및 버전의 프레임워크를 개별 시스템 단위로 적용/관리하고
...
import EgovLeftNav from '@/components/leftmenu/EgovLeftNavAbout.vue';
